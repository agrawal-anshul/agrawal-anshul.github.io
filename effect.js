...
$("document").ready(function () {
    ...
    $(window).resize(function () {
        vw = $(window).width() / 2;
        $("#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#b910,#b911,#b912").stop();
        ...
        $("#b9100").animate({ top: 240, left: vw + 350 }, 500);
        $("#b9111").animate({ top: 240, left: vw + 450 }, 500);
        $("#b9122").animate({ top: 240, left: vw + 550 }, 500);
    });
    ...
    $("#balloons_flying").click(function () {
        ...
        $("#b1,#b4,#b5,#b8,#b9,#b912").addClass("balloons-rotate-behaviour-one");
        $("#b2,#b3,#b6,#b7,#b910,#b911").addClass("balloons-rotate-behaviour-two");
